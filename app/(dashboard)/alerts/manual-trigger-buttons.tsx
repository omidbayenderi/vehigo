  ...
  return (
    <div className="p-5">
      ...
      <p className="mb-4 text-sm text-ink-faint">
        {canRunScanner
          ? "Tek bütçeli Europe Web Scout ile tüm Avrupa pazarlarını şimdi tarayın veya bekleyen eşleşmeleri Telegram’a gönderin."
      ...
      <div className="flex flex-wrap gap-2">
        {canRunScanner ? <form action={scanAction}>
          ...
          >
            ...
            {scanPending ? "Avrupa taranıyor..." : "Avrupa'yı tara (tek agent)"}
          </button>
        </form> : null}
