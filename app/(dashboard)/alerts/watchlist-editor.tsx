  ...
  return (
    <form action={action} className="mt-4 rounded-lg border border-brand/30 bg-surface p-4">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-3">
        ...
        <label className="text-sm"><span className="mb-1 block text-ink-soft">Eşleşme modu</span><select name="search_mode" defaultValue={watchlist.search_mode ?? "strict"} className={inputClass}><option value="strict">Strict · filtreleri kesin uygula</option><option value="discovery">Discovery · ikincil eksikleri doğrula</option></select></label>
