...
- Live status: BLOCKED. Browser security policy rejected Supabase access, so migration `0033_force_manual_site_agent_scan.sql` was not applied and the code was intentionally not deployed. Production remains on the previous healthy scheduled-scanner release.
